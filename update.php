    ...
    <div class="card mt-4">
      ...
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="password" class="form-control" name="UserPass" placeholder="Enter password" value="<?php echo $data['UserPass'];?>">
        </div>
        <div class="form-group">
      <label for="Confirm">Confirm Password:</label>
      <input type="password" class="form-control" required name="Confirm" placeholder="Confirm password" value="<?php echo $data['UserPass'];?>">
    </div>
      </div>
    </div>
